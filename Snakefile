...
rule busco:
    ...
    shell:
        ...
        "if [ $actualsize -ge $minimumsize ]; then " \
        "run_busco -q -c {threads} -t bac_tmp.${{file:33:-3}} -i $file -o bacteria_odb10.${{file:39:-3}} -l {params.busco_folder}/bacteria_odb10 -m geno; " \
        "run_busco -q -c {threads} -t euk_tmp.${{file:33:-3}} -i $file -o eukaryota_odb10.${{file:39:-3}} -l {params.busco_folder}/eukaryota_odb10 -m geno; " \
        "run_busco -q -c {threads} -t emb_tmp.${{file:33:-3}} -i $file -o embryophyta_odb10.${{file:39:-3}} -l {params.busco_folder}/embryophyta_odb10 -m geno; " \
        "run_busco -q -c {threads} -t fun_tmp.${{file:33:-3}} -i $file -o fungi_odb10.${{file:39:-3}} -l {params.busco_folder}/fungi_odb10 -m geno; " \
        "run_busco -q -c {threads} -t met_tmp.${{file:33:-3}} -i $file -o metazoa_odb10.${{file:39:-3}} -l {params.busco_folder}/metazoa_odb10 -m geno; " \
