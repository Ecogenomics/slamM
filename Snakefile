...
rule get_read_pools:
    ...
    shell:
         ...
         ' printf " --output-fastq-files "; for file in data/binned_reads/*.long.list; do printf "$file[0,-6].fastq.gz "; done; printf "\n") && ' \
         ...
         ' printf " --output-fastq-files "; for file in data/binned_reads/*.short.list; do printf "$file[0,-6].1.fastq.gz "; done; printf "\n") && ' \
         ...
         ' printf " --output-fastq-files "; for file in data/binned_reads/*.short.list; do printf "$file[0,-6].2.fastq.gz "; done; printf "\n")'
